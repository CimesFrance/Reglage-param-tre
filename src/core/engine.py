"""Module de fonctions de calcul pour l'application de réglage de paramètres granulométriques.
...
def erreur_minim(
        params_correct, tamis_originale, cumulatif_originale, tamis_pratique, cumulatif_pratique):
